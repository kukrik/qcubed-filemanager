 ...
 */
;(function($) {
  var pluginName = 'scrollpad';

  function Plugin(element, options) {
    var el = element;
    var $el = $(element);
    var $scrollContentEl;
    var $contentEl = $el.find('.scroll-wrapper:first');
    var $scrollbarEl;
    var $dragHandleEl;
    var dragOffset;
    var flashTimeout;
    ...
    function init() {
      ...
      $el.prepend('<div class="scrollpad-scrollbar"><div class="drag-handle"></div></div>');
      $scrollbarEl = $el.find('.scrollpad-scrollbar:first');
      $dragHandleEl = $el.find('.drag-handle:first');

      if (options.wrapContent) {
        $contentEl.wrap('<div class="scrollpad-scrollbar-content" />');
      }
      $scrollContentEl = $el.find('.scrollpad-scrollbar-content:first');
      ...
      $(window).on('resize.trackScrollPad', recalculate);
    ...
    function destroy() {
      ...
      $(window).off('resize.trackScrollPad');
