<?php
    ...
    class Select2ListBoxBaseGen extends Q\Project\Control\ListBox
    {
        ...
        /**
         * Constructs and returns an array of jQuery options based on the properties of the current object.
         * The method checks each relevant property and, if not null, maps it to a corresponding key-value
         * pair in the option array.
         *
         * @return array An associative array of jQuery configuration options.
         */
...
//        if (!is_null($val = $this->SelectOnClose)) {$jqOptions['selectOnClose'] = $val;}
        ...
        /**
         * Retrieves the name of the jQuery setup function to be used for initializing the current object.
         *
         ...
         * Maps predefined property names to corresponding private or protected properties
         * within the class and returns their values. If the property name is not recognized,
         * it attempts to call the parent::__get method.
         *
         * @param string $strName The name of the property to retrieve.
         *
         * @return mixed The value of the requested property, or the result of the parent::__get method
         *               if the property is not directly managed by this class.
         *
         ...
         * Validates and casts the provided value to the correct type based on the property being set,
         * then updates the corresponding option for the jQuery widget.
         * If the property value fails to cast correctly, an exception is thrown.
         *
